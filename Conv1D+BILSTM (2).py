...
input_csv = "/content/drive/My Drive/deep-learning/team_project/combined_sentences_전자상거래.csv"
df = pd.read_csv(input_csv)

# Define the characters to remove
weird_characters = ['o/','n/','(',')' 'm/']

# Function to remove weird characters from a string
def clean_text(text):
...
output_csv = '/content/drive/My Drive/deep-learning/team_project/combined_sentences_chr.csv'
